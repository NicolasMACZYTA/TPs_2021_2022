...
int main(int argc, char** argv){
    ...
    if(0<open(argv[1],O_RDONLY)){
        attron(A_STANDOUT);
        mvprintw(25, 0, "F2 pour quitter, entree pour editer, haut, bas pour changer de bloc de 128 octets");
        attroff(A_STANDOUT);
