...
C=\{3\}   & \tr{C}{a}{\emptyset} & & \tr{C}{a}{\emptyset} \\
          & \tr{C}{b}{\{4\}}     & \{4\} = E & \tr{C}{b}{E} \\
D=\{2\}   & \tr{D}{a}{\{3\}}     & \{3\} = C & \tr{D}{a}{D} \\
          & \tr{D}{b}{\emptyset} & & \tr{D}{b}{G} \\
E=\{4\}   & \tr{E}{a}{\{6\}}     & \{4,6\} = F & \tr{E}{a}{F} \\
          & \tr{E}{b}{\{5\}}     & \{4,5\} = G & \tr{E}{b}{G} \\
F=\{4,6\} & \tr{F}{a}{\{6\}}     & \{4,6\} = F & \tr{F}{a}{F} \\
          & \tr{F}{b}{\{5\}}     & \{4,5\} = G & \tr{F}{b}{G} \\
G=\{4,5\} & \tr{G}{a}{\{6\}}     & \{4,6\} = F & \tr{G}{a}{F} \\
          & \tr{G}{b}{\{5\}}     & \{4,5\} = G & \tr{G}{b}{G} \\ \hline
\end{array}$
\end{center}
...
\node[state, accepting, below of=F] (G) {G};
...
(E) edge[above] node{b} (G)
(F) edge[loop above] node{a} (F)
(G) edge[loop below] node{b} (G)
(F) edge[left, bend right] node{b} (G)
(G) edge[right, bend right] node{a} (F);
  \end{tikzpicture}
\end{center}
